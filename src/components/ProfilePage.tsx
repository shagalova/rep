...
const ProfilePage:FC = () => {
  return (
    <div className='max-width'>
        <div className="flex justify-between pt-[87px] px-40">
                <div className="profile">
                    <h2 className="text-2xl/[29.26px] text-left text-[#1C2A39]">PROFILE</h2>
                    <div className="profile2 flex gap-x-4">
                        <Image src="/profile-img.png" alt="defaultPhoto" width={235} height={235} className="object-fill"></Image>
                        <div className="right">
                ...
                <article className="bg-[#FFE0E2] shadow-[0px_24px_36px_0px_#35315447] pt-4 px-7 max-w-[353px] text-xs/[14.63px]">
                    <h2 className="text-center">ABOUT ME</h2>
                    <p className="pt-7 text-[#5C6A79] font-semibold">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed in ante consequat, 
